...
public class SequenceFileCreator {
  ...
  private static String getUsage() {
    return "SequnceFileCreator: <targetURI> (e.g. hdfs://path) <pathToTextDocument> <numOfRecords>";
  }

  public void create(String pathString, String sampleText, int num) throws IOException {
